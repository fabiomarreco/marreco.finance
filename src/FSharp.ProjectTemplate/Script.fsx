...
System.IO.File.ReadAllText("resource\\brazil-calendar.json") |> JsonConvert.DeserializeObject<Calendar>


System.IO.File.ReadAllText("resource\\brazil-calendar.json") |> JsonConvert.DeserializeObject


let json = JsonConvert.SerializeObject calendar
